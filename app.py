...
layout = dict(
    ...
    title="Word Cloud (histogram while we get a clickable cloud)",
    mapbox=dict(
                    ...
                    [
                        html.Div(
                            [
                                ...
                                html.H5(
                                    "Inflation and Financial Stability Reports", style={"margin-top": "0px"}
                                ),
                            ]
                        )
                    ],
        ...
        html.Div(
            [
                html.Div(
                    [
                        html.P(
                            "Filter by report date (or select range in bar chart):",
                        ...
                        html.P("Report sections and boxes:", className="control_label"),
                        dcc.RadioItems(
                            id="well_status_selector",
                            options=[
                                {"label": "All ", "value": "all"},
                                {"label": "Main body only", "value": "active"},
                                {"label": "Boxes only", "value": "graphs"},
                        ...
                        dcc.Checklist(
                            id="lock_selector",
                            options=[{"label": "cdd control (?)", "value": "locked"}],
                            className="dcc_control",
                            value=[],
                        ),
                        html.P("Filter by section:", className="control_label"),
                        dcc.RadioItems(
                            id="well_type_selector",
                            options=[
                                {"label": "All ", "value": "all"},
                                {"label": "Briefing ", "value": "productive"},
                                {"label": "Customize ", "value": "custom"},
                            ],
                            value="productive",
                            labelStyle={"display": "inline-block"},
                ...
                html.Div(
                    [
                        html.Div(
                            [
                                html.Div(
                                    [html.H6(id="well_text"), html.P("No. of Words")],
                                    id="wells",
                                    className="mini_container",
                                ),
                                html.Div(
                                    [html.H6(id="gasText"), html.P("No. of positive words")],
                                    id="gas",
                                    className="mini_container",
                                ),
                                html.Div(
                                    [html.H6(id="oilText"), html.P("No. of negative words")],
                                    id="oil",
                                    className="mini_container",
                                ),
                                html.Div(
                                    [html.H6(id="waterText"), html.P("No. of neutral words")],
                                    id="water",
                                    className="mini_container",
                                ),
                            ],
...
def make_count_figure(well_statuses, well_types, year_slider):
    ...
    layout_count["title"] = "Sentiment index"
